...
const dummyTransactions: ClientTransactionData[] = [
	{
...
export default function Page({ params }: { params: { clientId: number; startPeriod: number; endPeriod: number; } }) {
	return (
		<div className="overflow-x-auto relative shadow-md sm:rounded-lg">
			<p className="text-xl font-semibold my-4">Client ID: {params.clientId}</p>
